...
class PagosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pago" do
    assert_difference('Pago.count') do
      post pagos_url, params: { pago: { factura_id: @pago.factura_id, fechapago: @pago.fechapago, monto: @pago.monto } }
    end
  ...
  test "should update pago" do
    patch pago_url(@pago), params: { pago: { factura_id: @pago.factura_id, fechapago: @pago.fechapago, monto: @pago.monto } }
