...
class FacturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post facturas_url, params: { factura: { cliente_id: @factura.cliente_id, condicion: @factura.condicion, erssan: @factura.erssan, fecha: @factura.fecha, iva: @factura.iva, periodo_id: @factura.periodo_id, total: @factura.total } }
    end
  ...
  test "should update factura" do
    patch factura_url(@factura), params: { factura: { cliente_id: @factura.cliente_id, condicion: @factura.condicion, erssan: @factura.erssan, fecha: @factura.fecha, iva: @factura.iva, periodo_id: @factura.periodo_id, total: @factura.total } }
