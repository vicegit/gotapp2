...
class LecturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lectura" do
    assert_difference('Lectura.count') do
      post lecturas_url, params: { lectura: { actual: @lectura.actual, consumo: @lectura.consumo, exceso: @lectura.exceso, fecha: @lectura.fecha, lector: @lectura.lector, medidor_id: @lectura.medidor_id, periodo_id: @lectura.periodo_id } }
    end
  ...
  test "should update lectura" do
    patch lectura_url(@lectura), params: { lectura: { actual: @lectura.actual, consumo: @lectura.consumo, exceso: @lectura.exceso, fecha: @lectura.fecha, lector: @lectura.lector, medidor_id: @lectura.medidor_id, periodo_id: @lectura.periodo_id } }
