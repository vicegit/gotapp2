...
class ServiciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post servicios_url, params: { servicio: { concepto: @servicio.concepto, m3: @servicio.m3, tarifa: @servicio.tarifa } }
    end
  ...
  test "should update servicio" do
    patch servicio_url(@servicio), params: { servicio: { concepto: @servicio.concepto, m3: @servicio.m3, tarifa: @servicio.tarifa } }
